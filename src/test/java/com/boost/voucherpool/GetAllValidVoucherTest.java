...
public class GetAllValidVoucherTest {
    /**
     * mvn test -Dtest=GetAllValidVoucherTest
     * -Dhost= -Dport=
     * @throws URISyntaxException
     * @throws IOException
     */
    @Test
    public void getValidVouchers() throws URISyntaxException, IOException {
        ...
        for (VoucherCode vc : allVoucherCodes) {
            ...
            builder.setScheme("http").setHost(host).setPort(port)
                    .setPath("/VoucherPool/main/getAllValidVoucher")
